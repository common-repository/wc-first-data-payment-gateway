...
Contributors: virtinapro
Tags: First Data, First Data Gateway, Payment, Payment gateway, credicard pay, credit card
...
<h3>WooCommerce 2.6x Compatible</h3>
...
So that others can share in the answer, please submit your support requests through the WordPress forums for WC First Data Payment Gateway(http://wordpress.org/support/plugin/wc-first-data-payment-gateway).
